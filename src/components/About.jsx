  ...
  return (
    ...
    >
      ...
      <div className="my-about-con py-5 text-white">
        <h2 className="display-5 text-accent fw-bold mb-5 mx-2 text-start">
          What I Do
        </h2>
        <p className=" text-secondary mx-2 text-start fs-3 lh-lg mb-0 fw-normal my-4 ">
          I design and build modern, user-friendly digital experiences. My focus
          is on clean interfaces, responsive design, and performance-turning
          ideas into functional and visual appealing products.
        </p>
        <h2 className="display-5 text-accent text-start my-5 fw-bold mb-5 mx-2 ">
          My Approach
        </h2>
      ...
      <div className="d-flex container justify-content-between mt-5">
        ...
        >
          <h2
            className="display-4 text-start fw-bold mb-1 "
            style={{
              color: "#00ff9d",
            }}
          >
        ...
        >
          <h2
            className="display-4 text-start fw-bold mb-0 "
            style={{
              color: "#00ff9d",
            }}
          >
